...
const file_service_simple_bank_proto_rawDesc = "" +
	"\n" +
	"\x19service_simple_bank.proto\x12\x02pb\x1a\x1cgoogle/api/annotations.proto\x1a\x15rpc_create_user.proto\x1a\x14rpc_login_user.proto\x1a\x15rpc_update_user.proto\x1a.protoc-gen-openapiv2/options/annotations.proto2\xca\x03\n" +
	"\n" +
	...
	"Login user\x1a?Use this API to login user and get access token & refresh token\x82\xd3\xe4\x93\x02\x13:\x01*\"\x0e/v1/login_userB\x88\x01\x92Ab\x12`\n" +
	"\x0fSimple Bank API\"H\n" +
	"\x03lcy\x12.https://github.com/grpc-ecosystem/grpc-gateway\x1a\x11xxxxx@example.com2\x031.2Z!github.com/Hain2000/simplebank/pbb\x06proto3"
